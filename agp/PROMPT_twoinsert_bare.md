...
are not part of your task — do not touch them and stay clear of them. The
demonstration is a video file; `ffmpeg` and Python 3 with Pillow are
available for extracting frames into `scratch/`.
